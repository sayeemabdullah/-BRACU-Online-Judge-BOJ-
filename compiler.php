...
<div class="topbar">
  <div class="topnav-right">
        ...
        <a href="compiler.php"><i class="fa fa-terminal"></i> Online Compiler</a>
        <a href="problemset.php"><i class="fa fa-puzzle-piece"></i> Problem Archive</a>
        <a href="submissionstat.php"><i class="fa fa-user"></i> My Account</a>
</div>
